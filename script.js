...
document.getElementById('desafioHTML').addEventListener('click', function(event) {
  ...
  document.getElementById('desafioJS').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalDesafioJS').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeDesafioJS').addEventListener('click', function() {
    document.getElementById('modalDesafioJS').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalDesafioJS');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });

  document.getElementById('desafioDOM').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalDesafioDOM').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeDesafioDOM').addEventListener('click', function() {
    document.getElementById('modalDesafioDOM').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalDesafioDOM');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });

  document.getElementById('requisitosHTML').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalRequisitosHTML').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeRequisitosHTML').addEventListener('click', function() {
    document.getElementById('modalRequisitosHTML').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalRequisitosHTML');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });
  
  document.getElementById('requisitosCSS').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalRequisitosCSS').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeRequisitosCSS').addEventListener('click', function() {
    document.getElementById('modalRequisitosCSS').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalRequisitosCSS');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });

  document.getElementById('requisitosJS').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalRequisitosJS').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeRequisitosJS').addEventListener('click', function() {
    document.getElementById('modalRequisitosJS').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalRequisitosJS');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });

  document.getElementById('requisitosDOM').addEventListener('click', function(event) {
    event.preventDefault(); // Impede o comportamento padrão do label
    document.getElementById('modalRequisitosDOM').style.display = 'flex'; // Mostra o modal
  });
  
  document.getElementById('closeRequisitosDOM').addEventListener('click', function() {
    document.getElementById('modalRequisitosDOM').style.display = 'none'; // Esconde o modal
  });
  
  // Fecha o modal se clicar fora dele
  window.addEventListener('click', function(event) {
    const modal = document.getElementById('modalRequisitosDOM');
    if (event.target === modal) {
      modal.style.display = 'none';
    }
  });
